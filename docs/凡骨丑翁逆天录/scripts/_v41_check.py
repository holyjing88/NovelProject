# -*- coding: utf-8 -*-
"""v41 正文综合10校验：ch001-063 + ch130（64章）"""
...
short, high, meta, missing_status = [], [], [], []
...
print("CHAPTERS", len(V41_CHAPTERS))
print("SHORT", short)
print("HIGH_DUP", high)
print("META_CH", meta)
print("MISSING_STATUS", missing_status)

# v40 留存数据仅覆盖 ch001-049
risks = []
...
if os.path.isfile(churn_path):
    ...
    risks = [
        ...
        for c in d["chapters"]
        if c["n"] <= 49
        and (c["daily_risk"] > 1.05 or c["batch_risk"] > 1.05 or c["dup"] >= 0.02)
    ]
print("RISK_CH001_049", risks)
